    ...
    <div class="col-md-12">
      	<div class="box box-info">
            <div class="box-header with-border">
              	<h3 class="box-title">Authmenu Add</h3>
            </div>
            <?php echo form_open('authmenu/add'); ?>
          	<div class="box-body">
          		<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="authmenu" value="<?php echo $this->input->post('authmenu'); ?>" class="form-control" id="authmenu" />
						</div>
					</div>
				</div>
			</div>
